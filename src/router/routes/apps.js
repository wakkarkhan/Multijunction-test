...
export default [{
    ...
    {
        path: '/apps/dummy/product_tabs',
        name: 'products_tabs',
        component: () =>
            import ('@/views/apps/dummy/product_tabs.vue'),
    },
    {
        path: '/apps/dummy/modal',
        name: 'dummy_modal',
        component: () =>
            import ('@/views/apps/dummy/modal.vue'),
    },
    {
        path: '/apps/dummy/dummyTable',
        name: 'dummyTable',
        component: () =>
            import ('@/views/apps/dummy/table.vue'),
    },
    {
        path: '/apps/dummy/ebayCategory',
        name: 'ebayCategory',
        component: () =>
            import ('@/views/apps/dummy/ebay_category.vue'),
    },
    {
        path: '/apps/dummy/breadCrumTable',
        name: 'breadCrumTable',
        component: () =>
            import ('@/views/apps/dummy/BreadCrumTable.vue'),
        meta: {
            pageTitle: 'Custom Field Allocation',
            breadcrumb: [{
                    text: 'Custom Fields',
                },
                {
    ...
    {
        path: '/apps/dummy/productInformation',
        name: 'productInformation',
        component: () =>
            import ('@/views/apps/dummy/Product_Information.vue'),
        meta: {
            pageTitle: 'Add New Product',
        },
    },
    {
        path: '/apps/dummy/ProductList',
        name: 'ProductList',
        component: () =>
            import ('@/views/apps/dummy/ProductList.vue'),
        meta: {
            pageTitle: 'Product Listing',
        },
    },
    {
        path: '/apps/dummy/flashInformation',
        name: 'flashInformation',
        component: () =>
            import ('@/views/apps/dummy/FlashDealInformation.vue'),
        meta: {
            pageTitle: 'Flash Deal Information',
        },
    },
    {
        path: '/apps/dummy/websiteHeader',
        name: 'websiteHeader',
        component: () =>
            import ('@/views/apps/dummy/WebsiteHeader.vue'),
        meta: {
            pageTitle: 'Website Header',
        },
    },
    {
        path: '/apps/dummy/websiteFooter',
        name: 'websiteFooter',
        component: () =>
            import ('@/views/apps/dummy/WebsiteFooter.vue'),
        meta: {
            pageTitle: 'Website Footer',
        },
    },
    {
        path: '/apps/dummy/websiteSetup',
        name: 'websiteSetup',
        component: () =>
            import ('@/views/apps/dummy/WebsiteSetup.vue'),
        meta: {
            pageTitle: 'Website Setup',
        },
    },
    {
        path: '/apps/dummy/colorSelector',
        name: 'colorSelector',
        component: () =>
            import ('@/views/apps/dummy/colorSelector.vue'),
        meta: {
